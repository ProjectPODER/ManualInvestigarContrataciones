...
Este manual es una iniciativa del `Proyecto sobre Organización, Desarrollo, Educación e Investigación (PODER) <https://www.projectpoder.org/es>`_ para facilitar el trabajo de investigación con contratos a partir de la plataforma `QuiénEsQuién.Wiki <https://www.quienesquien.wiki>`_ . Para dudas, comentarios o mejoras escribir a `info@quienesquien.wiki <mailto:info@quienesquien.wiki>`_ .
